 ...
 * 数据访问接口的实现
 */
public class MultiThreadDAOImpl implements ThreadDAO {

    private MultiDBHelper mHelper = null;

    public MultiThreadDAOImpl(Context context) {
        this.mHelper = MultiDBHelper.getInstance(context);
    }
    ...
    public synchronized void deleteThreadByUrl(String url) {
        SQLiteDatabase db = mHelper.getWritableDatabase();
    ...
    public List<ThreadInfo> getThreads(String url) {
        ...
        while (cursor.moveToNext()) {
            ...
            thread.setEnd(cursor.getInt(cursor.getColumnIndex("ended")));
