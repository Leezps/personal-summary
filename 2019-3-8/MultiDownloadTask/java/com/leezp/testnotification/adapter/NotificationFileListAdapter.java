 ...
 * 文件列表适配器
 */
public class NotificationFileListAdapter extends BaseAdapter {
    private Context mContext = null;
    private List<FileInfo> mFileList = null;
    private Messenger mMessenger = null;

    public NotificationFileListAdapter(Context mContext, List<FileInfo> mFileList) {
...
//                    intent.setAction(NotificationDownloadService.ACTION_START);
//                    intent.putExtra("fileInfo",fileInfo);
//                    mContext.startService(intent);
                    Message msg = new Message();
                    msg.what = NotificationDownloadService.MSG_START;
                    msg.obj = fileInfo;
                    try {
                        mMessenger.send(msg);
            ...
            holder.btStop.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //通知Service停止下载
//                    Intent intent = new Intent(mContext, NotificationDownloadService.class);
//                    intent.setAction(NotificationDownloadService.ACTION_STOP);
//                    intent.putExtra("fileInfo",fileInfo);
//                    mContext.startService(intent);
                    Message msg = new Message();
                    msg.what = NotificationDownloadService.MSG_STOP;
                    msg.obj = fileInfo;
                    try {
                        mMessenger.send(msg);
                    } catch (RemoteException e) {
