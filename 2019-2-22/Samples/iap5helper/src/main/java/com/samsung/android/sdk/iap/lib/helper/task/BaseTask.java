...
public class BaseTask extends AsyncTask<String, Object, Boolean>
{
    ...
    protected void onPostExecute( Boolean _result )
    {
        ...
        {
            mErrorVo.setError(mErrorVo.getErrorCode(), mContext.getString(HelperResource.getIdByName(mContext.getApplicationContext(),"string","mids_sapps_pop_unknown_error_occurred")));
        }
        // ================================================================
