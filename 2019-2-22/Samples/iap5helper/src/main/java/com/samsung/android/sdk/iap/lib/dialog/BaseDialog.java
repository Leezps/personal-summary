                              ...
                              
{
    ...
    protected void onCreate( Bundle savedInstanceState )
    {
        ...
        int colorResId = getContext()
                             .getResources()
                                 .getColor(HelperResource.getIdByName(getContext().getApplicationContext(),"color","text_accent"));
    ...
    private ViewGroup initContentView()
    {
        ...
        {
            mContentView = (ViewGroup)getLayoutInflater().inflate(HelperResource.getIdByName(getContext().getApplicationContext(),"layout","base_dialog"),null );
    ...
    private void setUserContentLayout( View v )
    {
        ...
        // ====================================================================
        mFlCustomContent = (FrameLayout)v.findViewById(HelperResource.getIdByName(getContext().getApplicationContext(),"id","base_dialog_custom_view"));
        // ====================================================================

        // 1. Dialog 사용자 메시지 영역 텍스트뷰를 참조한다.
        // ====================================================================
        mTvCustomMessage = (TextView)v.findViewById(HelperResource.getIdByName(getContext().getApplicationContext(),"id","base_dialog_custom_message"));
        // ====================================================================
    }
