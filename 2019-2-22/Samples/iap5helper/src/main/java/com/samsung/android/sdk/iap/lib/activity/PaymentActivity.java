...
public class PaymentActivity extends BaseActivity
{
    ...
    protected void onCreate( Bundle savedInstanceState )
    {
        ...
        {
            Toast.makeText( this,
                    HelperResource.getIdByName(getApplicationContext(),"string","mids_sapps_pop_an_invalid_value_has_been_provided_for_samsung_in_app_purchase"),
                            Toast.LENGTH_LONG ).show();
         
            // Set error to pass result to third-party application
            // ----------------------------------------------------------------
            mErrorVo.setError( HelperDefine.IAP_ERROR_COMMON,
                               getString(HelperResource.getIdByName(getApplicationContext(),"string","mids_sapps_pop_an_invalid_value_has_been_provided_for_samsung_in_app_purchase")) );
            // ----------------------------------------------------------------
            ...
            case HelperDefine.REQUEST_CODE_IS_IAP_PAYMENT:
            {
                ...
                else if( RESULT_CANCELED == _resultCode )
                {
                    mErrorVo.setError( HelperDefine.IAP_PAYMENT_IS_CANCELED,
                                       getString(HelperResource.getIdByName(getApplicationContext(),"string","mids_sapps_pop_payment_canceled")));
    ...
    private void finishPurchase( Intent  _intent )
    {
            ...
            if( mErrorVo.getErrorCode() == HelperDefine.IAP_ERROR_NONE )
            {
                ...
                */
                ...
                mErrorVo.setError(
                        ...
                        getString(HelperResource.getIdByName(getApplicationContext(),"string","dlg_msg_payment_success")) );
        ...
        {
            mErrorVo.setError( HelperDefine.IAP_ERROR_COMMON,
                  getString(HelperResource.getIdByName(getApplicationContext(),"string","mids_sapps_pop_unknown_error_occurred")) );
