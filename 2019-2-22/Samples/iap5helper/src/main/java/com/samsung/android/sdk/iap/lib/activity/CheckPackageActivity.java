                ...
                switch (DialogType) {
                    case HelperDefine.DIALOG_TYPE_INVALID_PACKAGE:{
                        ...
                        HelperUtil.showIapDialogIfNeeded(
                                this,
                                getString(HelperResource.getIdByName(getApplicationContext(),"string","mids_sapps_header_samsung_in_app_purchase_abb")),
                                getString(HelperResource.getIdByName(getApplicationContext(),"string","mids_sapps_pop_an_invalid_installation_of_in_app_purchase_has_been_detected_check_and_try_again")),
                                true,
                                null,
                                true);
                        // ------------------------------------------------------------
                    ...
                    case HelperDefine.DIALOG_TYPE_DISABLE_APPLICATION:{
                        ...
                        HelperUtil.showIapDialogIfNeeded(this,
                                getString(HelperResource.getIdByName(getApplicationContext(),"string","mids_sapps_header_samsung_in_app_purchase_abb")),
                                getString(HelperResource.getIdByName(getApplicationContext(),"string","mids_sapps_pop_unable_to_open_samsung_in_app_purchase_msg")),
                                true,
                                runnable,
                                true);
                        mFinishFlag = false;
                    ...
                    case HelperDefine.DIALOG_TYPE_APPS_DETAIL:{
                        ...
                        // ====================================================================
                        HelperUtil.showIapDialogIfNeeded( this,
                                getString(HelperResource.getIdByName(getApplicationContext(),"string","mids_sapps_header_update_galaxy_apps")),
                                getString(HelperResource.getIdByName(getApplicationContext(),"string","mids_sapps_pop_a_new_version_is_available_galaxy_apps_will_be_updated_to_the_latest_version_to_complete_this_purchase")),
                                true,
                                OkBtnRunnable,
                                true );
                        // ====================================================================
