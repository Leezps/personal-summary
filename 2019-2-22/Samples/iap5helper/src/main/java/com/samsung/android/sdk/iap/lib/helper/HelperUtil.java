...
public class HelperUtil {
    ...
    static public void installAppsPackage( final BaseActivity _activity )
    {
        ...
        errorVo.setError( HelperDefine.IAP_PAYMENT_IS_CANCELED,
                _activity.getString(HelperResource.getIdByName(_activity.getApplicationContext(),"string","mids_sapps_pop_payment_canceled")) );
        // ====================================================================

        // 3. Show information dialog
        // ====================================================================
        HelperUtil.showIapDialogIfNeeded( _activity,
                _activity.getString(HelperResource.getIdByName(_activity.getApplicationContext(),"string","mids_sapps_header_update_galaxy_apps")),
                _activity.getString(HelperResource.getIdByName(_activity.getApplicationContext(),"string","mids_sapps_pop_a_new_version_is_available_galaxy_apps_will_be_updated_to_the_latest_version_to_complete_this_purchase")),
                true,
                OkBtnRunnable,
                true );
        // ====================================================================
