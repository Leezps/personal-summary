    ...
    protected void onBindIapFinished(int _result)
    {
        ...
        else
        {
            if(getServiceProcess()!= null) {
                ...
                errorVo.setError(HelperDefine.IAP_ERROR_INITIALIZATION, mContext.getString(HelperResource.getIdByName(mContext.getApplicationContext(),"string","mids_sapps_pop_unknown_error_occurred"))+"[Lib_Bind]");
