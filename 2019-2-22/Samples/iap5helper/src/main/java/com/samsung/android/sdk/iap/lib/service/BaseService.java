...
public abstract class BaseService {
    ...
    public void onEndProcess( ) {
        ...
        if( mErrorVo.getErrorCode() == HelperDefine.IAP_ERROR_NEED_APP_UPGRADE )
        {
            ...
            intent.putExtra( "Title", mContext.getString(HelperResource.getIdByName(mContext.getApplicationContext(),"string","mids_sapps_header_samsung_in_app_purchase_abb")) );
