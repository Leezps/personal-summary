...
import com.leezp.library.core.CompressImageUtil;
...
public class CompressImageManager implements CompressImage {
    ...
    private CompressImage.CompressListener listener; // 压缩的监听(集合)
    ...
    private CompressImageManager(Context context, CompressConfig config,
        ...
        this.compressImageUtil = new CompressImageUtil(config, context);
        this.images = images;
